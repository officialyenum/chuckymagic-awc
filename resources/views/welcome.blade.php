...
<body>
    ...
    <header id="home" class="header text-white h-fullscreen text-center text-lg-left"
        style="background-image: url({{ asset('img/preview/awc1.jpg') }});" data-overlay="7">
            ...
            <div class="container">
                ...
                <div class="row gap-y">
                    ...
                    <div class="col-md-8 mx-auto">
                        <img src="{{ asset('img/preview/awc-logo.jpg') }}" alt="..." data-aos="fade-up"
            ...
            <div class="container">
                ...
                <div class="row gap-y align-items-center">
                    <div class="col-md-6 ml-auto">
                        <h4>AWC Manifesto</h4>
                        <p>To Create an atmosphere where people of different Personalities, Nationalities yet similar
                            mindset can interact in harmony, network and support one another’s growth through
                            recreation.</p>
                    </div>
                ...
                <div class="row gap-y align-items-center">
                    <div class="col-md-6 mr-auto">
                        <h4>AWC Mission</h4>
                        <p>To create a safe space to develop lasting relationships that allow every member grow both
                            personally and professionally; in addition to unparalleled business growth.
                        </p>
                    </div>
                ...
                <header class="section-header">
                    <h2>The AWC Dream</h2>
                    <hr>
                    <p class="lead">That one day we will transcend to a point where we will have factions of
                        this community across the globe.
                    </p>
                </header>
